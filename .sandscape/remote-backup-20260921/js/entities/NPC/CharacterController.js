...
export default class CharacterController extends Component{
    constructor(model, clips, scene, physicsWorld){
        ...
        // BOSS EXCEPTION (see entry.js): the summit beast is the finale, so it gets the full
        // 100 HP + a 45 HP punch — a real duel on the arena floor, not one punch like the
        // wreck-field beast. The controller is class-agnostic; the entry.js spawn decides.
        this.health = 20;
        this.maxHealth = 20;
